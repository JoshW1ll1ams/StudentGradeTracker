...
public class StudentPanel extends JPanel{
	...
	public StudentPanel(int windowWidth, int windowHeight)
	{
		...
		resetButton = new Button("Reset", Main.lightPurple);
		exitButton = new Button("Exit", Main.lightRed);
		bottomButtonPanel = new bottomPanel(exitButton,resetButton);
	...
	static void drawRows(ArrayList<StudentRow> students) {
		...
		for (int i = 0; i < students.size(); i++) {
		    students.get(i).setBounds(0, (rowcounter * 50), windowWidth, 40);
	...
	public static void positionElements() {
		...
		scrollFrame.setBounds(15,175,windowWidth-45,windowHeight-300);

		
		bottomButtonPanel.setBounds(0,windowHeight-100,windowWidth,65);
		resetButton.setBounds((windowWidth/2)-(windowWidth/8)-10,bottomButtonPanel.getHeight()/4,windowWidth/8,bottomButtonPanel.getHeight()/2);
		exitButton.setBounds((windowWidth/2)+10,bottomButtonPanel.getHeight()/4,windowWidth/8,bottomButtonPanel.getHeight()/2);
